!(function(e, t) {
  ...
  (b.Callbacks = function(e) {
    ...
    var n,
      ...
      c = function(t) {
        ...
        (n = !1),
          u && (l ? l.length && c(l.shift()) : r ? (u = []) : f.disable());
      },
      f = {
        add: function() {
          if (u) {
        ...
        b(function() {
          ...
          u &&
            ...
            e.getComputedStyle &&
              ...
              ((r = d.appendChild(
                o.createElement("div")
              )).style.cssText = d.style.cssText = s),
  ...
  function B(e, n, r, i) {
    if (b.acceptData(e)) {
      ...
      if ((p && f[p] && (i || f[p].data)) || !u || r !== t)
        return (
          p || (l ? (e[s] = p = c.pop() || b.guid++) : (p = s)),
          f[p] || ((f[p] = {}), l || (f[p].toJSON = b.noop)),
          ("object" == typeof n || "function" == typeof n) &&
            (i
              ? (f[p] = b.extend(f[p], n))
              : (f[p].data = b.extend(f[p].data, n))),
          (o = f[p]),
          i || (o.data || (o.data = {}), (o = o.data)),
          r !== t && (o[b.camelCase(n)] = r),
          u ? null == (a = o[n]) && (a = o[b.camelCase(n)]) : (a = o),
          a
        );
    }
  }
      ...
      if (s[u]) {
        if (t && (o = n ? s[u] : s[u].data)) {
          b.isArray(t)
            ...
            : t in o
            ? (t = [t])
            : (t = (t = b.camelCase(t)) in o ? [t] : t.split(" "));
          ...
          if (
            ...
            for (r = o.attributes; r.length > a; a++)
              (i = r[a].name).indexOf("data-") ||
                ((i = b.camelCase(i.slice(5))), R(o, i, s[i]));
  ...
  b.fn.extend({
    ...
    hasClass: function(e) {
      for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace(z, " ").indexOf(t) >= 0
        )
          return !0;
      return !1;
    },
  ...
  (b.event = {
            ...
            (p = v.handle) ||
              ((p = v.handle = function(e) {
                return typeof b === i || (e && b.event.triggered === e.type)
                  ? t
                  : b.event.dispatch.apply(p.elem, arguments);
              }).elem = e),
            l = (n = (n || "").match(T) || [""]).length;
          l--;
    ...
    trigger: function(n, r, i, a) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          ...
          ((n = n[b.expando]
            ? n
            : new b.Event(g, "object" == typeof n && n)).isTrigger = !0),
          (n.namespace = m.join(".")),
        ...
        if (!a && !f.noBubble && !b.isWindow(i)) {
          for (
            c = f.delegateType || g, te.test(c + g) || (l = l.parentNode);
            l;
            l = l.parentNode
          )
            h.push(l), (p = l);
        ...
        for (d = 0; (l = h[d++]) && !n.isPropagationStopped(); )
          (n.type = d > 1 ? c : f.bindType || g),
            (s =
              (b._data(l, "events") || {})[n.type] && b._data(l, "handle")) &&
              s.apply(l, r),
            (s = u && l[u]) &&
              b.acceptData(l) &&
              s.apply &&
    ...
    b.support.submitBubbles ||
      (b.event.special.submit = {
        ...
        teardown: function() {
          return (
            !b.nodeName(this, "form") && (b.event.remove(this, "._submit"), t)
          );
        }
      }),
    ...
    (function(e, t) {
        ...
        return n !== f && 9 === n.nodeType && n.documentElement
          ? ((f = n),
            ...
            (w.getByName = ie(function(e) {
              ...
              return (
                (w.getIdNotName = !n.getElementById(x)), p.removeChild(e), t
              );
            })),
            ...
            (i.find.TAG = w.tagNameNoComments
              ? function(e, n) {
      ...
      (oe.matchesSelector = function(e, t) {
        if (
          ...
          (t = t.replace(K, "='$1']")),
          !(!w.matchesSelector || d || (g && g.test(t)) || h.test(t)))
        )
          try {
            var n = m.call(e, t);
            if (
        ...
        return (
          ...
          re(function(o, a, s, u) {
            var l,
              ...
              m = !e || (!o && t) ? g : he(g, p, e, s, u),
              y = n ? (i || (o ? e : h || r) ? [] : a) : m;
            if ((n && n(m, y, s, u), r))
              for (l = he(y, d), r(l, [], s, u), c = l.length; c--; )
                (f = l[c]) && (y[d[c]] = !(m[d[c]] = f));
            if (o) {
              if (i || e) {
                if (i) {
        ...
        var n = 0,
          ...
          s = function(s, u, c, p, d) {
            ...
            if (((v += b), o && b !== v)) {
              ...
              H.apply(p, y),
                T && !s && y.length > 0 && v + t.length > 1 && oe.uniqueSort(p);
            }
            return T && ((N = k), (l = w)), x;
          };
        return o ? re(s) : s;
      ...
      function ve(e, t, n, r) {
        ...
        if (!r && 1 === f.length) {
          ...
          for (
            o = X.needsContext.test(e) ? 0 : a.length;
            o-- && ((u = a[o]), !i.relative[(l = u.type)]);
            ...
            if (
              ...
              (r = c(
                ...
                (U.test(a[0].type) && t.parentNode) || t
              ))
            ) {
              if ((a.splice(o, 1), !(e = r.length && fe(a))))
      ...
      (s = oe.compile = function(e, t) {
        ...
        if (!o) {
          for (t || (t = ce(e)), n = t.length; n--; )
            (o = me(t[n]))[x] ? r.push(o) : i.push(o);
          o = S(e, ye(i, r));
        }
        return o;
      }),
        (i.pseudos.nth = i.pseudos.eq),
        (i.filters = be.prototype = i.pseudos),
        (i.setFilters = new be()),
        c(),
        (oe.attr = b.attr),
        (b.find = oe),
    ...
    closest: function(e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = ue.test(e) || "string" != typeof e ? b(e, t || this.context) : 0;
        i > r;
        r++
      )
        for (
      ...
      function(e, t) {
        b.fn[e] = function(n, r) {
          ...
          return (
            ...
            (i = this.length > 1 && !le[e] ? b.unique(i) : i),
  ...
  function _e(e, n) {
    ...
    if (!s)
      for (s = [], r = e.childNodes || e; null != (o = r[a]); a++)
        !n || b.nodeName(o, n) ? s.push(o) : b.merge(s, _e(o, n));
  ...
  (Se.optgroup = Se.option),
    ...
    b.fn.extend({
      ...
      remove: function(e, t) {
        for (var n, r = 0; null != (n = this[r]); r++)
          (!e || b.filter(e, [n]).length > 0) &&
            (t || 1 !== n.nodeType || b.cleanData(_e(n)),
            n.parentNode &&
              (t && b.contains(n.ownerDocument, n) && He(_e(n, "script")),
              n.parentNode.removeChild(n)));
        return this;
      },
      empty: function() {
        for (var e, t = 0; null != (e = this[t]); t++) {
          for (1 === e.nodeType && b.cleanData(_e(e, !1)); e.firstChild; )
          ...
          function(e) {
            ...
            if (
              !(
                "string" != typeof e ||
                Te.test(e) ||
                (!b.support.htmlSerialize && ge.test(e)) ||
                (!b.support.leadingWhitespace && me.test(e)) ||
              ...
              try {
                for (; i > r; r++)
                  1 === (n = this[r] || {}).nodeType &&
                    (b.cleanData(_e(n, !1)), (n.innerHTML = e));
                n = 0;
              } catch (e) {}
            }
      ...
      domManip: function(e, n, r) {
        ...
        if (
          m ||
          (!(1 >= f || "string" != typeof g || b.support.checkClone) &&
            Ne.test(g))
        )
        ...
        if (
          f &&
          ((i = (l = b.buildFragment(e, this[0].ownerDocument, !1, this))
            .firstChild),
          ...
          for (
            n = n && b.nodeName(i, "tr"),
              a = (s = b.map(_e(l, "script"), De)).length;
            f > c;
            c++
          )
            (o = l),
              c !== h &&
                ((o = b.clone(o, !0, !0)), a && b.merge(s, _e(o, "script"))),
              r.call(
          ...
          if (a)
            for (
              u = s[s.length - 1].ownerDocument, b.map(s, Le), c = 0;
              a > c;
              c++
            )
              (o = s[c]),
    ...
    b.each(
      ...
      function(e, t) {
        b.fn[e] = function(e) {
          for (var n, r = 0, i = [], o = b(e), a = o.length - 1; a >= r; r++)
    ...
    b.extend({
      clone: function(e, t, n) {
        ...
        if (
          ...
          for (r = _e(o), s = _e(e), a = 0; null != (i = s[a]); ++a)
            r[a] && Me(i, r[a]);
        if (t)
          if (n)
            for (s = s || _e(e), r = r || _e(o), a = 0; null != (i = s[a]); a++)
              qe(i, r[a]);
          else qe(e, o);
        return (
          (r = _e(o, "script")).length > 0 && He(r, !u && _e(e, "script")),
          (r = s = i = null),
          o
        );
      },
      buildFragment: function(e, t, n, r) {
        for (
          var i, o, a, s, u, l, c, f = e.length, p = pe(t), d = [], h = 0;
          f > h;
          h++
        )
          if ((o = e[h]) || 0 === o)
              ...
              if (
                ...
                for (
                  ...
                  b.nodeName((l = o.childNodes[i]), "tbody") &&
                    !l.childNodes.length &&
                    o.removeChild(l);
              for (b.merge(d, s.childNodes), s.textContent = ""; s.firstChild; )
                s.removeChild(s.firstChild);
              s = p.lastChild;
            } else d.push(t.createTextNode(o));
        for (
          s && p.removeChild(s),
            b.support.appendChecked || b.grep(_e(d, "input"), Fe),
            h = 0;
          (o = d[h++]);
      ...
      cleanData: function(e, t) {
        for (
          ...
          if ((t || b.acceptData(n)) && (a = (o = n[u]) && l[o])) {
            if (a.events)
              for (r in a.events)
                p[r] ? b.event.remove(n, r) : b.removeEvent(n, r, a.handle);
            l[o] &&
              (delete l[o],
              f
                ? delete n[u]
      ...
      (r = e[a]).style &&
        ...
        t
          ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              et(r) &&
              (o[a] = b._data(r, "olddisplay", ot(r.nodeName))))
          : o[a] ||
            ((i = et(r)),
            ((n && "none" !== n) || !i) &&
  ...
  function rt(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += b.css(e, n + Qe[o], !0, i)),
        r
          ? ("content" === n && (a -= b.css(e, "padding" + Qe[o], !0, i)),
            "margin" !== n &&
              (a -= b.css(e, "border" + Qe[o] + "Width", !0, i)))
          : ((a += b.css(e, "padding" + Qe[o], !0, i)),
            "padding" !== n &&
              (a += b.css(e, "border" + Qe[o] + "Width", !0, i)));
    return a;
  }
  function it(e, t, n) {
    ...
    if (0 >= i || null == i) {
      if (
        ((0 > (i = Pe(e, t, o)) || null == i) && (i = e.style[t]), Ue.test(i))
      )
        return i;
  ...
  b.fn.extend({
    ...
    b.extend({
      ...
      style: function(e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
            ...
            l = e.style;
          if (
            ((n = b.cssProps[u] || (b.cssProps[u] = Ze(l, u))),
      ...
      css: function(e, n, r, i) {
        var o,
          ...
          u = b.camelCase(n);
        return (
          (n = b.cssProps[u] || (b.cssProps[u] = Ze(e.style, u))),
          (s = b.cssHooks[n] || b.cssHooks[u]) &&
            "get" in s &&
            (a = s.get(e, !0, r)),
          a === t && (a = Pe(e, n, i)),
          ...
          "" === r || r
            ? ((o = parseFloat(a)), !0 === r || b.isNumeric(o) ? o || 0 : a)
            : a
        );
      },
    ...
    b.each(["height", "width"], function(e, n) {
      b.cssHooks[n] = {
        get: function(e, r, i) {
          return r
            ? 0 === e.offsetWidth && Ie.test(b.css(e, "display"))
              ? b.swap(e, Je, function() {
                  return it(e, n, i);
                })
              : it(e, n, i)
            : t;
    ...
    b(function() {
      b.support.reliableMarginRight ||
        (b.cssHooks.marginRight = {
          get: function(e, n) {
            return n
              ? b.swap(e, { display: "inline-block" }, Pe, [e, "marginRight"])
              : t;
          }
        }),
        !b.support.pixelPosition &&
          ...
          b.each(["top", "left"], function(e, n) {
            b.cssHooks[n] = {
              get: function(e, r) {
                return r
                  ? ((r = Pe(e, n)), Ue.test(r) ? b(e).position()[n] + "px" : r)
                  : t;
              }
            };
          });
    ...
    b.extend({
      ...
      ajax: function(e, n) {
        ...
        ((f.data && f.hasContent && !1 !== f.contentType) || n.contentType) &&
          N.setRequestHeader("Content-Type", f.contentType),
        N.setRequestHeader(
          "Accept",
        ...
        f.headers))
          N.setRequestHeader(i, f.headers[i]);
        if (f.beforeSend && (!1 === f.beforeSend.call(p, N, f) || 2 === x))
          return N.abort();
        for (i in ((w = "abort"), { success: 1, error: 1, complete: 1 }))
          N[i](f[i]);
        if ((l = At(kt, f, n, N))) {
          (N.readyState = 1),
            u && d.trigger("ajaxSend", [N, f]),
            f.async &&
              f.timeout > 0 &&
        ...
        function C(e, n, r, i) {
          ...
          2 !== x &&
            ...
            (e >= 200 && 300 > e) || 304 === e
              ? (f.ifModified &&
                  ((w = N.getResponseHeader("Last-Modified")) &&
                    (b.lastModified[o] = w),
                  (w = N.getResponseHeader("etag")) && (b.etag[o] = w)),
                204 === e
                  ? ((c = !0), (C = "nocontent"))
                  : 304 === e
                  ? ((c = !0), (C = "notmodified"))
            ...
            (N.status = e),
            (N.statusText = (n || C) + ""),
            c ? h.resolveWith(p, [y, C, N]) : h.rejectWith(p, [N, C, v]),
            N.statusCode(m),
            (m = t),
            u && d.trigger(c ? "ajaxSuccess" : "ajaxError", [N, f, c ? y : v]),
            g.fireWith(p, [N, C]),
            u &&
              (d.trigger("ajaxComplete", [N, f]),
  ...
  (b.ajaxSettings.xhr = e.ActiveXObject
    ...
    (b.support.cors = !!qt && "withCredentials" in qt),
    (qt = b.support.ajax = !!qt) &&
                  ...
                  try {
                    if (r && (i || 4 === u.readyState))
                      if (
                        ((r = t),
                        a &&
                          ((u.onreadystatechange = b.noop), _t && delete Ht[a]),
                        i)
                      )
      ...
      function(e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          "inline" === b.css(e, "display") &&
            "none" === b.css(e, "float") &&
            (b.support.inlineBlockNeedsLayout && "inline" !== ot(e.nodeName)
              ? (d.zoom = 1)
        ...
        if ((o = g.length)) {
          "hidden" in (s = b._data(e, "fxshow") || b._data(e, "fxshow", {})) &&
            (m = s.hidden),
            u && (s.hidden = !m),
            m
              ? b(e).show()
      ...
      (function(e, t) {
        ...
        for (i in e)
          if (
            ...
            for (i in ((n = a.expand(n)), delete e[r], n))
    ...
    return (
      (function(e, t) {
        b.each(t, function(t, n) {
          for (
            var r = (It[t] || []).concat(It["*"]), i = 0, o = r.length;
            o > i;
            i++
          )
    ...
    (b.offset = {
      setOffset: function(e, t, n) {
        ...
        var i,
          ...
          c = {},
          f = {};
        ("absolute" === r || "fixed" === r) && b.inArray("auto", [u, l]) > -1
